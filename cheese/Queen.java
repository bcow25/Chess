...
public class Queen extends Piece { //dont question the code idk how to comment just trust 
        ...
        protected void loadImage() {
            try {
                if(pieceColor){
                    killme = ImageIO.read(new File("images/chess_pieces/Dark_Queen.png")).getScaledInstance(50,50,Image.SCALE_DEFAULT);
                } else {
                    killme = ImageIO.read(new File("images/chess_pieces/Light_Queen.png")).getScaledInstance(50,50,Image.SCALE_DEFAULT);
                }
